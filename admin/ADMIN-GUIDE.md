...
2. Натисніть «Увійти через Google» і виберіть робочий Google-акаунт.
3. На сторінці «Адмінпанель» відкрийте потрібний розділ.
4. Після завершення роботи натисніть «Вийти» у верхній панелі.

![Екран входу в адмінпанель](../output/playwright/admin-guide/login.png)

### Що позначено на екрані входу

① **Увійти через Google** — єдиний спосіб входу. Google-акаунт має бути попередньо доданий супер-адміном у систему.
...
Раздел позволяет искать анкеты по фамилии ребёнка или имени родителя, сортировать список, просматривать заполненные данные, открывать историю версий, сравнивать версии, экспортировать запись в PDF и импортировать CSV из Google Forms.
